  ...
  render() {
    ...
    if (this.props.post !== null) {
      ...
      content = (
        <React.Fragment>
          <Col xs="12" md="12">
            {reactHtmlParser(this.props.post.title.rendered)}
          </Col>
          <Col xs="12" md="12">
            {catTags}
          </Col>
          <Col xs="12" md="12">
            <img className="post-img" alt={this.props.post.title.rendered} src={this.props.post.medialink} />
          </Col>
          <Col xs="12" md="12">
            {reactHtmlParser(this.props.post.content.rendered)}
          </Col>
        </React.Fragment>
      );
    }
...
const mapDispatchToProps = (dispatch) => {
  return {
    onLoadSinglePost: (pid) => {
      dispatch(actionMethods.loadSinglePost(pid));
    },
  };
};
