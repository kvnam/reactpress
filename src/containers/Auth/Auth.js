      ...
      <React.Fragment>
        ...
        <Switch>
          ...
          <Route
            path="/auth/signup"
            render={() => (
              <SignUp user={this.state.user} inputChanged={this.onInputClicked} onFormSubmit={this.onUserSignUp} />
            )}
          />
...
const mapDispatchToProps = (dispatch) => {
  return {
    onUserSigninSubmit: (user) => {
      dispatch(actionMethods.userSignin(user));
    },
    onUserSignUpSubmit: (user) => {
      dispatch(actionMethods.userSignup(user));
    },
  };
};
